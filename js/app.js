...
const updateIdx = (idx) => {
      ...
      if (vBtns.length > 0) {
        ...
        } else if (product.handle === "selena" && vBtns.length === 2 && total === 4) {
          vIdx = currentIdx < 2 ? 0 : 1; // 0-1 Classic, 2-3 Noir
        ...
        } else if (product.handle === "bella" && vBtns.length === 2 && total === 4) {
          vIdx = currentIdx < 2 ? 1 : 0; // 0-1 Teal Blue, 2-3 Pearl White -> Teal Blue->#1, Pearl White->#3
